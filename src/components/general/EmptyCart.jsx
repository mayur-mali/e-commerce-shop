...
export default function EmptyCart() {
  return (
    <div>
      <h3 className="text-4xl capitalize font-medium text-center">
        Your carts is empty...!
      </h3>
      <svg
        data-name="Layer 1"
      ...
      >
        <script
          ...
          src="chrome-extension://glgdblbcgpdinelnmbkkcdjcgcggopng/webpack_common.js"
        />
        <script
          xmlns=""
          type="text/javascript"
          src="chrome-extension://glgdblbcgpdinelnmbkkcdjcgcggopng/webpack_content.js"
        />
